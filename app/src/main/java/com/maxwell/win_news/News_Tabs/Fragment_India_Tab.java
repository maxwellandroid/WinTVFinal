...
public class Fragment_India_Tab extends Fragment {
    ...
    TextView hiden_image1, hiden_image2, hiden_image3, card1_news_id, card3_news_id, card2_news_id;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.tab_india_fragment, container, false);

        news_list = (ListView) view.findViewById(R.id.news_list);
        ViewGroup header = (ViewGroup) inflater.inflate(R.layout.tab_india_fragment_header, news_list, false);
        news_list.addHeaderView(header);

        //loading_layout=(LinearLayout) header.findViewById(R.id.loading_layout);
        ...
        new JsonTask_three_card().execute("http://www.wintvindia.com/api/category.php?category_id=2");
        new JsonTask_image().execute("http://www.wintvindia.com/api/slider_news.php?category_id=2");
        new JsonTask_flash_news().execute("http://www.wintvindia.com/api/flashnews.php");

        card1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                three_card_full_news("card_one");
            }
        });
        card2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                three_card_full_news("card_two");
            }
        });
        card3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                three_card_full_news("card_three");
            }
        });
