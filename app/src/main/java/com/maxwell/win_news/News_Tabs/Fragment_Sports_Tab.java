...
public class Fragment_Sports_Tab extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.tab_sports_fragment, container, false);

        news_list=(ListView)view.findViewById(R.id.news_list);
        ViewGroup header = (ViewGroup)inflater.inflate(R.layout.tab_sports_fragment_header,news_list,false);
       ...
       new JsonTask_three_card().execute("http://www.wintvindia.com/api/category.php?category_id=4");
       new JsonTask_image().execute("http://www.wintvindia.com/api/slider_news.php?category_id=4");
    ...
    public void three_card_full_news(String cad_no) {
        if(cad_no.equals("card_one"))
        {
            ...
            i.putExtra("news_section","விளையாட்டு");
            startActivity(i);
        }
...
*/
    ...
    public class MovieAdapter extends ArrayAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            news_section.setText("விளையாட்டு");
