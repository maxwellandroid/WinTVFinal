...
public class MainActivity_new extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    private MainActivity_new mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(MainActivity_new.this,Display_Favorite_news.class);
                startActivity(i);
            }
        });
      ...
      //  viewPager.setPageTransformer(true, new CubeOutTransformer());
        } catch (Exception e){Toast.makeText(MainActivity_new.this, e.toString(), Toast.LENGTH_SHORT).show();}
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) MainActivity_new.this.getSystemService(Context.SEARCH_SERVICE);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_upload) {
            Toast.makeText(MainActivity_new.this, "Coming soon", Toast.LENGTH_SHORT).show();
        }
